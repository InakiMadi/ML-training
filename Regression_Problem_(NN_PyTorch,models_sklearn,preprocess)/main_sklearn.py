...
''' 
    Data acquisition 
'''
dataframe = pd.read_csv("./input/home-data-for-ml-course/train.csv")
validation_df = pd.read_csv("./input/home-data-for-ml-course/test.csv")
validation_Id = validation_df['Id']
